...
public class SearchInfo implements java.io.Serializable {
	...
	// type e.g. provider, product, service
	...
	public SearchInfo() {
		this.page = 1; //Default to page 1 to allow for unchecked conversion to string in SearchServices \o/
		this.pageSize = 10;
		this.random = false;
		this.apiCall = false;
	}
	...
	public synchronized Integer getPage() {
		return page;
	}

	public synchronized void setPage(Integer page) {
		this.page = page;
	}
