...
{	
	...
	public Date getLastReviewedAsDate() {
		return lastReviewedAsDate;
	}


	public void setLastReviewedAsDate(Date lastReviewedAsDate) {
		this.lastReviewedAsDate = lastReviewedAsDate;
	}
